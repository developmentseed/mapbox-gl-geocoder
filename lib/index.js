 ...
 * @param {Boolean|Object} [options.flyTo] If false, animating the map to a selected result is disabled. If true, animating the map will use the default animation parameters. If an object, it should describe the destination and animation of the transition for flyTo. See [GL JS documentation](https://docs.mapbox.com/mapbox-gl-js/api/#map#flyto) for details.
...
MapboxGeocoder.prototype = {
   ...
   * @returns {Boolean|Object} The flyTo option. If an object, it should describe the destination and animation of the transition for flyTo. See [GL JS documentation](https://docs.mapbox.com/mapbox-gl-js/api/#map#flyto) for details.
   */
  getFlyTo: function(){
